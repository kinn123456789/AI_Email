...
def sync_sent_mail_style_examples():
    ...
    an occasional catch-up for replies sent directly from Gmail instead of
    through this app — the app itself already saves every reply sent via
    ...
    # relative to when it actually runs, not to whenever this module was
    # first imported.
